...
import BranchPerformance from './pages/dashboards/BranchPerformance';
import MarketSharePage from './pages/dashboards/MarketSharePage';
import DepartmentPerformance from './pages/dashboards/DepartmentPerformance';
              ...
              userRole ? (
                <DashboardLayout role={userRole} onLogout={handleLogout}>
                  <Routes>
                    ...
                    <Route path="/market-share" element={<MarketSharePage />} />
